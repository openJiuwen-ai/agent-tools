...
class Preprocessor:
    ...
    def process(self, request: ChatCompletionRequest, agent_hints: AgentHints, request_id: str) -> RouteHint:
        """处理请求并转换为路由提示"""
        ...
        if agent_hints:
            ...
            estimated_output_tokens = agent_hints.estimated_output_tokens or self.default_estimated_output_tokens
